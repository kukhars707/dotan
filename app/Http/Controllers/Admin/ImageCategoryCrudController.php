...
use App\Http\Requests\ImageCategoryRequest as StoreRequest;
use App\Http\Requests\ImageCategoryRequest as UpdateRequest;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\Validator;

class ImageCategoryCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Admin\ImageCategory');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/image-category');
        $this->crud->setEntityNameStrings('изображения категорию', 'Ка');
